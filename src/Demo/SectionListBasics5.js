...
export default class SectionListBasics5 extends SPRNComponent {
    ...
    return (
      <View key={item}>
          <Button
                ...
                onPress={ ()=> {
                    //RNCalliOSAction.openNativePage({'pageName': 'SPRNBaseController', 'modularName':'SectionListBasics5'});
                    this.openNativePage('SectionListBasics5');
                }}
            />
            <Button
                title='Next2'
...
AppRegistry.registerComponent('SectionListBasics5', () => SectionListBasics5);