...
export default class SectionListBasics4 extends SPRNComponent {
    ...
    return (
      <View key={item}>
          <Button
                ...
                onPress={ ()=> {
                    //RNCalliOSAction.openNativePage({'pageName': 'SPRNBaseController', 'modularName':'SectionListBasics4'});
                    this.openNativePage('SectionListBasics4');
                }}
            />
            <Button
                title='Next2'
...
AppRegistry.registerComponent('SectionListBasics4', () => SectionListBasics4);