...
export default class SectionListBasics8 extends SPRNComponent {
    ...
    return (
      <View key={item}>
          <Button
                ...
                onPress={ ()=> {
                    //RNCalliOSAction.openNativePage({'pageName': 'SPRNBaseController', 'modularName':'SectionListBasics8'});
                    this.openNativePage('SectionListBasics8');
                }}
            />
            <Button
                title='Next2'
...
AppRegistry.registerComponent('SectionListBasics8', () => SectionListBasics8);