...
export default class SectionListBasics3 extends SPRNComponent {
    ...
    return (
      <View key={item}>
          <Button
                ...
                onPress={ ()=> {
                    //RNCalliOSAction.openNativePage({'pageName': 'SPRNBaseController', 'modularName':'SectionListBasics3'});
                    this.openNativePage('SectionListBasics3');
                }}
            />
            <Button
                title='Next2'
...
AppRegistry.registerComponent('SectionListBasics3', () => SectionListBasics3);