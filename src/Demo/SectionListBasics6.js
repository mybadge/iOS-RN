...
export default class SectionListBasics6 extends SPRNComponent {
    ...
    return (
      <View key={item}>
          <Button
                ...
                onPress={ ()=> {
                    //RNCalliOSAction.openNativePage({'pageName': 'SPRNBaseController', 'modularName':'SectionListBasics6'});
                    this.openNativePage('SectionListBasics6');
                }}
            />
            <Button
                title='Next2'
...
AppRegistry.registerComponent('SectionListBasics6', () => SectionListBasics6);